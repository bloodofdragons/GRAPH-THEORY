...
public:
    ...
    // checks whether there is a path between s and d
    bool is_path(int s, int d)
    {
        vbool visited(v);
...
// we just have to check whether there is a path between source and destination or not
// if there is a path then return true
// else return false
