...
public:
      ...
      {
        vbool visited(v);
        vi colour(v,-1);  // -1 hai mtlb coloures nahi hai 

        foreach(i,colour) cout<<i<<" ";
        cout<<endl;
        queue<int> q;
        colour[src]=0;
        q.push(src);
        ...
        while(not q.empty())
        {
          ...
          { 
            cout<<"curr="<<curr<<endl;
            cout<<"i="<<i<<endl;
            cout<<"colour of i= "<<colour[i]<<endl;
            if(colour[i]==-1)  // colour do
            {
            ...
            {
              if(colour[i]==colour[curr]) return false;
            }
          }
        }
          foreach(i,colour) cout<<i<<" ";
